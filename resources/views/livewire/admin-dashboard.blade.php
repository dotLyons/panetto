                            ...
                            <table class="w-full text-left border-collapse min-w-[700px]">
                                ...
                                <tbody class="divide-y divide-gray-100 text-sm">
                                    @forelse($products as $prod)
                                        <tr
                                            class="hover:bg-panetto-accent/10 transition group {{ !$prod->active ? 'bg-gray-50 opacity-75' : '' }}">
                                                ...
                                                <div
                                                    ...
                                                    @if ($prod->image_path)
                                                        <img src="{{ Storage::url($prod->image_path) }}"
                                                            class="w-full h-full object-contain {{ !$prod->active ? 'grayscale' : '' }}">
                                                    @else
                                                        <span class="text-2xl opacity-40">🥐</span>
                                                    @endif
                                                </div>
                                                <span
                                                    class="font-bold text-gray-800 text-base group-hover:text-panetto-orange transition">
                                                    {{ $prod->name }}
                                                </span>
                                            </td>
                                            <td class="p-4">
                                            ...
                                            <td class="p-4 text-center">
                                                <button wire:click="toggleProductVisibility({{ $prod->id }})"
                                                    class="transition transform hover:scale-110 focus:outline-none"
                                                    title="{{ $prod->active ? 'Ocultar producto' : 'Mostrar producto' }}">
                                                    @if ($prod->active)
                                                        <span
                                                            class="text-green-500 bg-green-100 p-2 rounded-full shadow-sm border border-green-200">
                                                            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5"
                                                                fill="none" viewBox="0 0 24 24"
                                                                stroke="currentColor">
                                                                <path stroke-linecap="round" stroke-linejoin="round"
                                                    ...
                                                    @else
                                                        <span
                                                            class="text-gray-400 bg-gray-200 p-2 rounded-full shadow-inner border border-gray-300">
                                                            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5"
                                                                fill="none" viewBox="0 0 24 24"
                                                                stroke="currentColor">
                                                                <path stroke-linecap="round" stroke-linejoin="round"
